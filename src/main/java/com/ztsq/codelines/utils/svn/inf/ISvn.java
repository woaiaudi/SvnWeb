package com.ztsq.codelines.utils.svn.inf;
...
public interface ISvn extends ISvnService {
	 ...
	 */
	public void getCommitHistory(String svnUrl, String startDate, String endDate, String authName, ISVNLogEntryHandler logEntryHandler);
