...
public class FileUtil {
	 ...
	 * 读取文件字节数组
	 */
//	public static byte[] readFileToBytesxxxxxxxxx(String path) {
...
//	}
	 ...
	 */
	public static boolean copyFile(ByteArrayOutputStream outputStream, String destFileName, boolean overlay)
			throws IOException {
